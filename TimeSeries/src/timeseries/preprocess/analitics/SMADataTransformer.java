...
public class SMADataTransformer implements IDataTransform {
	...
	public Instances process(Instances instances, TransformParameters params) {
		...
		String attributeName = "SMA" + params.getPeriods();
		...
		try {
			...
			RetCode ret = lib.sma(0, outLength, prices, params.getPeriods(), outBegIdx, outNBElement, outReal);
