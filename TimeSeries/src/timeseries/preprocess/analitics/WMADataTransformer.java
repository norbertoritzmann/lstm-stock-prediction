...
public class WMADataTransformer implements IDataTransform {
	...
	public Instances process(Instances instances, TransformParameters params) {
		...
		String attributeName = "WMA" + params.getPeriods();
		...
		try {
			...
			RetCode ret = lib.wma(0, outLength, prices, params.getPeriods(), outBegIdx, outNBElement, outReal);
