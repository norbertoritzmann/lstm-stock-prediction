...
public class EMADataTransformer implements IDataTransform {
	...
	public Instances process(Instances instances, TransformParameters params) {
		...
		String attributeName = "EMA" + params.getPeriods();
		...
		try {
			...
			RetCode ret = lib.ema(0, outLength, prices, params.getPeriods(), outBegIdx, outNBElement, outReal);
